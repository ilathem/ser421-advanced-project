...
## Svelte Tutorial
<br></br>
Svelte (the word, not the name) is defined as "slender and elegant," and it's very easy to see why once you've learned a bit about this framework. Svelte is intended to be a barebones framework for Javascript to make implementation as easy as possible. All you need to do to run the Svelte application is:
